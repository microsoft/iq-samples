...
def create_and_run_host(
    ...
    configure(
        service_name="RefundAgentTracing",
        service_namespace="RefundAgent",
    )
...
class GenericAgentHost:
    ...
    def _setup_handlers(self):
        ...
        async def on_installation_update(context: TurnContext, _: TurnState):
            ...
            if action == "add":
                await context.send_activity("Thank you for hiring me! Looking forward to assisting you with refund requests!")
            elif action == "remove":
